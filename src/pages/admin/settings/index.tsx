...
import { ProfileTab, AdminTab, InterfaceTab, MonitoringTab } from '../../../component';
...
const SettingsPage: React.FC = () => {
  ...
  const getAvailableTabs = () => {
    const tabs = [
      ...
      { id: 'monitoring' as TabType, label: 'Мониторинг изменений', icon: '📊' },
      { id: 'interface' as TabType, label: 'Интерфейс', icon: '🎨' },
    ];

    if (userRole === 'admin') {
      tabs.splice(1, 0, { id: 'admin' as TabType, label: 'Администрирование', icon: '⚙️' });
    }
