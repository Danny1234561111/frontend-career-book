...
const ManagerDashboard: React.FC = () => {
	...
	const departmentData = {
		...
		recentEvents: [
			{
				id: 1,
				text: 'Иванов И.И. получил новую оценку по компетенции "React"',
				date: '2024-03-15',
			},
			{
				id: 2,
				text: 'Обновлён учебный материал "TypeScript для начинающих"',
				date: '2024-03-14',
			},
			{
				id: 3,
				text: 'Изменены требования к должности "Ведущий разработчик"',
				date: '2024-03-13',
			},
		],
	};
